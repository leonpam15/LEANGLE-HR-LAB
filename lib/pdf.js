...
export async function generatePDF(quizTitle, primaryStyle, reportContent, leaderName = '') {
  return new Promise((resolve, reject) => {
    ...
    doc.fontSize(8.5).font('Helvetica').fillColor('#ffffff').text('Confidential', M, 26, { align: 'center', width: CW });
    ...
    const assessments = ['Leadership Communication', 'Conflict Resolution', 'Feedback', 'Decision-Making', 'Motivation', 'Stress', 'Personality'];
