...
export async function generatePDF(quizTitle, primaryStyle, reportContent, leaderName = '') {
  return new Promise((resolve, reject) => {
    ...
    doc.fontSize(15).font('Helvetica-Bold').fillColor('#fff').text(quizTitle, M, 320, {
...
export async function generatePDF(quizTitle, primaryStyle, reportContent, leaderName = '') {
  return new Promise((resolve, reject) => {
    ...
    doc.fontSize(12).font('Helvetica').fillColor('#666').text('certifies that', M, 110, { align: 'center', width: CW });
    ...
    doc.fontSize(12).font('Helvetica').fillColor('#666').text('has successfully completed the', M, 200, { align: 'center', width: CW });
